<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="UpdateMember.aspx.cs" Inherits="Mini_LibraryManagementSystem.UpdateMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="menu">
        <div class="title">
            <h3>Member | Update<asp:Button ID="Button1" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" Width="43px" />
            </h3>
        </div>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:TextBox ID="txtPkpt" CssClass="mem_txtbox" runat="server" Width="300px" Height="33px" OnTextChanged="txtPkpt_TextChanged2" MaxLength="6"></asp:TextBox>
                    </td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td class="auto-style7 pt-2" colspan="4" align="center">
                        <asp:Button ID="btnUpdate" runat="server" class="btn btn-sm btn-success me-1" Text="Update"  Width="100px" Height="40px" OnClick="btnUpdate_Click"  />
                        <asp:Button ID="btnClear" runat="server" class="btn btn-sm btn-success" Text="Clear"  Width="100px" Height="40px" OnClick="btnClear_Click" />
                    </td>
                </tr>
            </table>
