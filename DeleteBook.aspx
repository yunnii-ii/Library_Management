<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DeleteBook.aspx.cs" Inherits="Mini_LibraryManagementSystem.DeleteBook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="menu bg-white">
        <div class="title">
            <h3>View Book | 
                <asp:Button ID="Button1" runat="server" BackColor="White" BorderStyle="None" Height="17px" Width="22px" />
            </h3>
        </div>
        <div class="mt-3" align="center">
            ...
            <asp:Button ID="btnDel" class="btn btn-sm btn-danger mb-2" runat="server" OnClick="Button1_Click" Width="60px" Height="32px" Text="Delete" />
            <div class="pe-5">
